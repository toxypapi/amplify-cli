...
describe("ModelAuthTests", function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    var cf, BUILD_TIMESTAMP, STACK_NAME, BUCKET_NAME, LOCAL_FS_BUILD_DIR, S3_ROOT_DIR_KEY, GRAPHQL_ENDPOINT, GRAPHQL_CLIENT_1, GRAPHQL_CLIENT_1_ACCESS, GRAPHQL_CLIENT_2, GRAPHQL_CLIENT_3, USER_POOL_ID, USERNAME1, USERNAME2, USERNAME3, TMP_PASSWORD, REAL_PASSWORD, ADMIN_GROUP_NAME, DEVS_GROUP_NAME, PARTICIPANT_GROUP_NAME, WATCHER_GROUP_NAME, cognitoClient, customS3Client, awsS3Client;
    return __generator(this, function (_a) {
        cf = new CloudFormationClient_1.CloudFormationClient('us-west-2');
        BUILD_TIMESTAMP = moment().format('YYYYMMDDHHmmss');
        STACK_NAME = "ModelAuthTransformerTest-" + BUILD_TIMESTAMP;
        BUCKET_NAME = "appsync-auth-transformer-test-bucket-" + BUILD_TIMESTAMP;
        LOCAL_FS_BUILD_DIR = '/tmp/model_auth_transform_tests/';
        S3_ROOT_DIR_KEY = 'deployments';
        GRAPHQL_ENDPOINT = undefined;
        GRAPHQL_CLIENT_1 = undefined;
        GRAPHQL_CLIENT_1_ACCESS = undefined;
        GRAPHQL_CLIENT_2 = undefined;
        GRAPHQL_CLIENT_3 = undefined;
        USER_POOL_ID = undefined;
        USERNAME1 = 'user1@test.com';
        USERNAME2 = 'user2@test.com';
        USERNAME3 = 'user3@test.com';
        TMP_PASSWORD = 'Password123!';
        REAL_PASSWORD = 'Password1234!';
        ADMIN_GROUP_NAME = 'Admin';
        DEVS_GROUP_NAME = 'Devs';
        PARTICIPANT_GROUP_NAME = 'Participant';
        WATCHER_GROUP_NAME = 'Watcher';
        cognitoClient = new CognitoClient({ apiVersion: '2016-04-19', region: 'us-west-2' });
        customS3Client = new S3Client_1.S3Client('us-west-2');
        awsS3Client = new S3({ region: 'us-west-2' });
