...
const generateJavaPreset = (options, models) => {
    ...
    models.forEach(model => {
        ...
        config.push(Object.assign(Object.assign({}, options), { filename: path_1.join(...baseOutputDir, `${modelName}.java`), config: Object.assign(Object.assign({}, options.config), { scalars: Object.assign(Object.assign({}, scalars_1.JAVA_SCALAR_MAP), options.config.scalars), selectedType: modelName }) }));
    });
    // Class loader
    config.push(Object.assign(Object.assign({}, options), { filename: path_1.join(...baseOutputDir, `${java_config_1.LOADER_CLASS_NAME}.java`), config: Object.assign(Object.assign({}, options.config), { scalars: Object.assign(Object.assign({}, scalars_1.JAVA_SCALAR_MAP), options.config.scalars), generate: 'loader' }) }));
    return config;
};
