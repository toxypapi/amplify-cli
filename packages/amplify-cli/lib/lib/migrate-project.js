...
function migrateProject(context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (projectConfig.version !== constants.PROJECT_CONFIG_VERSION) {
            if (yield context.prompt.confirm(confirmMigrateMessage)) {
                ...
                if (yield context.prompt.confirm(secondConfirmMessage)) {
                    ...
                    yield migrateFrom0To1(context, projectPath, projectConfig);
                }
            }
        }
    });
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            for (let i = 0; i < categoryMigrationTasks.length; i++) {
                try {
                    yield categoryMigrationTasks[i]();
                }
                catch (e) {
                    throw e;
                }
