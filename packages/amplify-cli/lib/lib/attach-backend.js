...
function attachBackend(context, inputParams) {
...
function onSuccess(context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!inputParams.yes) {
            const confirmKeepCodebase = yield context.amplify.confirmPrompt.run('Do you plan on modifying this backend?', true);
...
//# sourceMappingURL=../../src/lib/lib/attach-backend.js.map