...
function isBackendDirModifiedSinceLastPush(resourceName, category, lastPushTimeStamp) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const localDirHash = yield getHashForResourceDir(localBackendDir);
        const cloudDirHash = yield getHashForResourceDir(cloudBackendDir);
...
function getResourcesToBeUpdated(amplifyMeta, currentamplifyMeta, category, resourceName, filteredResources) {
    return __awaiter(this, void 0, void 0, function* () {
        let resources = [];
        yield asyncForEach(Object.keys(amplifyMeta), (categoryName) => __awaiter(this, void 0, void 0, function* () {
            const categoryItem = amplifyMeta[categoryName];
            yield asyncForEach(Object.keys(categoryItem), (resource) => __awaiter(this, void 0, void 0, function* () {
                if (currentamplifyMeta[categoryName]) {
                    if (currentamplifyMeta[categoryName][resource] !== undefined && amplifyMeta[categoryName][resource] !== undefined) {
                        const backendModified = yield isBackendDirModifiedSinceLastPush(resource, categoryName, currentamplifyMeta[categoryName][resource].lastPushTimeStamp);
                        if (backendModified) {
                            amplifyMeta[categoryName][resource].resourceName = resource;
                            amplifyMeta[categoryName][resource].category = categoryName;
                            resources.push(amplifyMeta[categoryName][resource]);
...
function getResourceStatus(category, resourceName, providerName, filteredResources) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let resourcesToBeUpdated = yield getResourcesToBeUpdated(amplifyMeta, currentamplifyMeta, category, resourceName, filteredResources);
...
function showResourceTable(category, resourceName, filteredResources) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const { resourcesToBeCreated, resourcesToBeUpdated, resourcesToBeDeleted, allResources } = yield getResourceStatus(category, resourceName, undefined, filteredResources);
