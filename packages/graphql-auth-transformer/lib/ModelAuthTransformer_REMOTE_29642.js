...
All @auth directives used on field definitions are performed when the field is resolved and can be thought of as 'read' operations.`);
    ...
    authorizationExpressionForListResult(rules) {
        ...
        if (staticGroupAuthorizationRules.length > 0 || dynamicGroupAuthorizationRules.length > 0 || ownerAuthorizationRules.length > 0) {
            ...
            const ifNotStaticallyAuthedFilterObjects = graphql_mapping_template_1.iff(rules.some(r => r.and) ? graphql_mapping_template_1.raw('true') : graphql_mapping_template_1.raw(`! $${graphql_transformer_common_1.ResourceConstants.SNIPPETS.IsStaticGroupAuthorizedVariable}`), graphql_mapping_template_1.compoundExpression([
...
//# sourceMappingURL=ModelAuthTransformer_REMOTE_29642.js.map