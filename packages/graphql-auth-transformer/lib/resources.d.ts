...
export declare class ResourceFactory {
    ...
    auditExpression(rules: AuthRule[], authMode: AppSyncAuthMode): Expression;
    /**
     ...
     * @param variableToSet The name of the variable to set when auth is satisfied.
     */
    dynamicGroupAuthorizationExpressionForUpdateOrDeleteOperations(rules: AuthRule[], staticRules: AuthRule[], fieldBeingProtected?: string): Expression;
    private compoundRuleNames;
    /**
     ...
     * @param variableToSet The name of the variable to set when auth is satisfied.
     */
    ownerAuthorizationExpressionForUpdateOrDeleteOperations(rules: AuthRule[], staticRules: AuthRule[], fieldIsList: (fieldName: string) => boolean, fieldBeingProtected?: string): Expression;
    /**
    ...
    throwIfUnauthorized(rules: AuthRule[], field?: FieldDefinitionNode): Expression;
    ...
    appendItemIfLocallyAuthorized(rules: AuthRule[]): Expression;
