    ...
    protectUpdateOrDeleteMutation(ctx, resolverResourceId, rules, parent, modelConfiguration, isUpdate, field, ifCondition, subscriptionOperation) {
        ...
        if (!rules || rules.length === 0 || !resolver) {
            ...
            if (staticGroupAuthorizationRules.length > 0 ||
                ...
                const ifNotStaticallyAuthedCreateAuthCondition = graphql_mapping_template_1.iff(rules.some(r => r.and)
                    ? graphql_mapping_template_1.raw('true')
                    : graphql_mapping_template_1.raw(`! $${staticGroupAuthorizedVariable}`), graphql_mapping_template_1.compoundExpression([
...
//# sourceMappingURL=ModelAuthTransformer_BASE_29642.js.map