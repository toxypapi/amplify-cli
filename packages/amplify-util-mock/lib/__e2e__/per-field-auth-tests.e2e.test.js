...
test('test field auth on an operation type as user in admin group', () => __awaiter(void 0, void 0, void 0, function* () {
    const queryResponse = yield GRAPHQL_CLIENT_1.query(`
    query SomeFunction {
      someFunction
    }
  `);
    // no errors though it should return null
    index_1.logDebug(queryResponse);
    expect(queryResponse.data.someFunction).toBeNull();
}));
test('test field auth on an operation type as user not in admin group', () => __awaiter(void 0, void 0, void 0, function* () {
    const queryResponse = yield GRAPHQL_CLIENT_3.query(`
    query SomeFunction {
      someFunction
    }
  `);
