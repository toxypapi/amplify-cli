...
var websocket_stream_1 = __importDefault(require("websocket-stream"));
...
var MQTTServer = /** @class */ (function (_super) {
    ...
    function MQTTServer(options, callback) {
        ...
        _this.options = extend_1.default(true, {}, DEFAULT_OPTIONS, options);
        _this._dedupId = 0;
        _this.clients = {};
        _this.closed = false;
        _this.closed = false;
    ...
    MQTTServer.prototype.attachHttpServer = function (server, path) {
        ...
        var wss = websocket_stream_1.default.createServer(opt);
