...
var AppSyncPipelineResolver = /** @class */ (function () {
    ...
    AppSyncPipelineResolver.prototype.resolve = function (source, args, context, info) {
        return __awaiter(this, void 0, void 0, function () {
            var requestMappingTemplate, responseMappingTemplate, result, stash, templateErrors;
            var _a, _b;
            var _this = this;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        (_a = requestMappingTemplate.render({ source: source, arguments: args, stash: stash }, context, info), result = _a.result, stash = _a.stash, templateErrors = _a.errors);
