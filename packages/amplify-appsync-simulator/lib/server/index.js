...
var AppSyncSimulatorServer = /** @class */ (function () {
    function AppSyncSimulatorServer(config, simulatorContext) {
        this.subscriptionServer = new subscription_1.SubscriptionServer(config, simulatorContext);
        this.operationServer = new operations_1.OperationServer(config, simulatorContext, this.subscriptionServer);
    }
    AppSyncSimulatorServer.prototype.start = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.subscriptionServer.start()];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.operationServer.start()];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
